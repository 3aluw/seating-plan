    ...
    <div class="conatiner">
        ...
        <div id="print" class="playground-cont shadow-lg mt-10 mb-5 outline outline-offset-0  ">
            <div class="relative student-rect" v-show="showPlayground"
                ...
                style="position: absolute;width:150px; border:black solid 1px; height: 50px">
...
const generateXObj = () => {
    for (let i = 1; i < studentsPerRow.value; i++) {
        ...
        i % 2 === 0 ? XObj.value.push(lastItemX + itemWidth.value + singleMargin.value * 2.5) : XObj.value.push(lastItemX + itemWidth.value + singleMargin.value)
    }
